...
public class WeightedNodePath implements Path<WeightedNode, WeightedNodePath> {
     ...
     * @requires node != null
     * @effects Creates a new WeightedNodePath which originates at node.
     */
	...
	/**
	 * Creates a WeightedNodePath from a WeightedNode and a WeigthedNodePath.
     * @requires node != null
     ...
     * @return true iff obj is a WeightedNodePath and obj.elements is the
     *   same sequence as this.elements
     */
  	@Override
  	public boolean equals(Object obj) {
    	if (obj instanceof WeightedNodePath)
      		return equals((WeightedNodePath)obj);
    	return false;
  	}
     ...
     */
  	public boolean equals(WeightedNodePath wnp) {
    	return (wnp != null) && node.equals(wnp.node) &&
               (path == null ? wnp.path == null : path.equals(wnp.path));
  	}
	 ...
	 */
  	@Override
  	public int hashCode() {
    	return node.hashCode() + (path == null ? 0 : 13*path.hashCode());
  	}
  	
  	
  	/** Compares the cost of this path to the given path.
  	 * @return the value 0 if the cost of this path is equal to the cost of
  	 *   the given path; a value less than 0 if this.cost is less than
  	 *   p.cost; and a value greater than 0 if this.cost is greater than p.cost.
